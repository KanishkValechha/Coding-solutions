...
bidirectional
bidirectional edge between nodes ai and bi.
Notice
Notice that the given graph may be disconnected.
Divide the nodes of the graph into m groups (
1-indexed
1-indexed) such that:
...
        return l;
    }
    int bfs(vector<int>& levels, vector<bool>& visited,
